...
public class UsageHeatmapScreen extends JFrame {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;

	public UsageHeatmapScreen(HashMap<String, Double> parkingSpotUsageMap) {
		// TODO Add the ability to create this map according to a time frame given by the user.
		...
		setTitle("Parking Spot Usage Heatmap");
		...
		panel.add(new HeatmapCanvas(numOfParkingSpots, parkingSpotUsageMap, 125, 100), BorderLayout.CENTER);
		
	}
	
	private class HeatmapCanvas extends Canvas {
		/**
		 * 
		 */
		private static final long serialVersionUID = 1L;
		...
		private HashMap<String, Double> parkingSpotUsageMap;
		...
		public HeatmapCanvas(int numOfParkingSpots, HashMap<String, Double> parkingSpotUsageMap, int startXoffset, int startYoffset) {
			this.numOfParkingSpots = numOfParkingSpots;
			this.parkingSpotUsageMap = parkingSpotUsageMap;
		...
		public void paint(Graphics g) {
			if (numOfParkingSpots == 5) {
				...
				for (int i = 0; i<numOfParkingSpots; i++) {
					double percentage = parkingSpotUsageMap.get("ParkingSpot"+(i+1));
					Color c = new Color((int)(percentage*255), 255 - (int)(percentage*255), 0);
					g.setColor(c);
				...
				for (int i = 0;i<numOfPSatTheSides; ps++, i++) {
					double percentage = parkingSpotUsageMap.get("ParkingSpot"+ps);
					Color c = new Color((int)(percentage*255), 255 - (int)(percentage*255), 0);
					g.setColor(c);
